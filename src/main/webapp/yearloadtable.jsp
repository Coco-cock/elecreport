...
<body>
					...
					<li><a class="active-menu" href="#"><i class="fa fa-table"></i>历史负荷数据表<span
						...
						<ul class="nav nav-second-level">
						   <li><a  href="${baseUrl}/"><i class="glyphicon glyphicon-list-alt"></i>实时负荷数据记录表</a></li>
							...
							<li><a class="list-group-item" href="${baseUrl}/yearloadtable"><i class="glyphicon glyphicon-list-alt"></i>年负荷数据记录表</a></li>
						</ul>
					</li>
    ...
    <script src="${baseUrl}/assets/js/dataTables/jquery.dataTables.js"></script>
    <script src="${baseUrl}/assets/js/dataTables/dataTables.bootstrap.js"></script>
    <script>
